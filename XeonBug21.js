...
title: ownername,
body: botname,
thumbnailUrl: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663557895138/WupSXVWHesHIGDEA.jpg",
sourceUrl: link,
mediaType: 1,
            ...
            requestPaymentMessage: {
                ...
                contextInfo: {
                    ...
                    externalAdReply: {
                        ...
                        renderLargerThumbnail: true,
                        previewType: "VIDEO",
                        sourceUrl: "https://t.me/VIP_1XB",
                        mediaUrl: "https://t.me/VIP_1XB",
                        showAdAttribution: true,
                    }
                }
            }
...
async function albumbuggers1(target, mention) {
  ...
  const imageCrash = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663557895138/WupSXVWHesHIGDEA.jpg";
...
async function CorosuelInvis77(X, mention = true) {
  const videoServer = await prepareWAMessageMedia({
    video: {
      url: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663557895138/dlORQtgwfVELKtLf.mp4"
    }
  }, {
    upload: XeonBotInc.waUploadToServer
  });
...
await sleep(100)
    ...
    const carouselContent = {
        carouselMessage: {
            cards: [
                {
                    jpegThumbnail: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663557895138/WupSXVWHesHIGDEA.jpg',
                    carouselCard: {
                        body: "T-Яyuichi",
                        buttons: [
                            {
                        ...
                        header: {
                            imageMessage: { jpegThumbnail: 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663557895138/WupSXVWHesHIGDEA.jpg' },
...
case 'xban': case 'XBODYban': {
    try {
        ...
        const imageUrl = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663557895138/WupSXVWHesHIGDEA.jpg";
...
let buttons = [
    ...
    let buttonMessage = {
        image: { url: `https://files.manuscdn.com/user_upload_by_module/session_file/310519663557895138/WupSXVWHesHIGDEA.jpg` },
	    gifPlayback: true,
        caption: menu,
        contextInfo: {
            forwardingScore: 999,
...
`;
    ...
    try {
        ...
        const videoUrl = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663557895138/dlORQtgwfVELKtLf.mp4"; // رابط مباشر للفيديو
    ...
    try {
        ...
        const audioUrl = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663504612457/pFnABOaJvrCWLuMg.mp3"; // ضع رابط الصوت المباشر هنا
    ...
    const oke = await XeonBotInc.sendMessage(from, {
        ...
        contextInfo: { 
            ...
            "externalAdReply": {
                ...
                "mediaUrl": 'https://files.manuscdn.com/user_upload_by_module/session_file/310519663557895138/WupSXVWHesHIGDEA.jpg',
